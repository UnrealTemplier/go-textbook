...
flowchart TD
  ...
  A["Операция Put"]:::process --> B["Вычисление хеша"]
...
flowchart LR
    ...
    classDef network  fill:#881337,stroke:#fb7185,stroke-width:1px,color:#f8fafc
    classDef accent   fill:#1e1b4b,stroke:#818cf8,stroke-width:1px,color:#f8fafc
  A["Открытая адресация"]:::process --> B["Локальность кэша: отлично"]
  A --> C["Удаление: сложно tombstone"]
  A --> D["Память: предсказуемо"]
  E["Цепочки"]:::process --> F["Локальность кэша: хуже"]
...
flowchart TD
    ...
    classDef network  fill:#881337,stroke:#fb7185,stroke-width:1px,color:#f8fafc
    classDef accent   fill:#1e1b4b,stroke:#818cf8,stroke-width:1px,color:#f8fafc
  A["Запись в растущую map"]:::warning --> B["Проверка oldbuckets"]
