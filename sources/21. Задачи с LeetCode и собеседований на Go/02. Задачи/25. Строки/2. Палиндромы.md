...
flowchart TD
    ...
    A["Задача на палиндром"]:::process --> B["Определить тип задачи"]
...
flowchart LR
    ...
    classDef network  fill:#881337,stroke:#fb7185,stroke-width:1px,color:#f8fafc
    classDef accent   fill:#1e1b4b,stroke:#818cf8,stroke-width:1px,color:#f8fafc
    A["Центр: позиция i"]:::process --> B["Расширение влево/вправо"]
    B --> C{"s[left] == s[right]?"}
    C -->|Да| D["left-- right++"]
...
flowchart TD
    ...
    classDef network  fill:#881337,stroke:#fb7185,stroke-width:1px,color:#f8fafc
    classDef accent   fill:#1e1b4b,stroke:#818cf8,stroke-width:1px,color:#f8fafc
    A["Edge cases для палиндромов"]:::process --> B["Пустая строка: ''"]
    A --> C["Один символ: 'a'"]
