...
flowchart TD
    ...
    A["Задача: Longest Palindromic Substring"]:::warning --> B["Выбор стратегии"]
...
flowchart LR
    ...
    classDef network  fill:#881337,stroke:#fb7185,stroke-width:1px,color:#f8fafc
    classDef accent   fill:#1e1b4b,stroke:#818cf8,stroke-width:1px,color:#f8fafc
    A["Исходная строка"]:::process --> B["Вставка разделителей: '#a#b#a#'"]
...
flowchart TD
    ...
    classDef network  fill:#881337,stroke:#fb7185,stroke-width:1px,color:#f8fafc
    classDef accent   fill:#1e1b4b,stroke:#818cf8,stroke-width:1px,color:#f8fafc
    A["Критерии выбора алгоритма"]:::error --> B["n < 1000?"]
...
flowchart TD
    ...
    classDef network  fill:#881337,stroke:#fb7185,stroke-width:1px,color:#f8fafc
    classDef accent   fill:#1e1b4b,stroke:#818cf8,stroke-width:1px,color:#f8fafc
    A["Проверка граничных условий"]:::warning --> B["len(s) == 0 или 1"]
