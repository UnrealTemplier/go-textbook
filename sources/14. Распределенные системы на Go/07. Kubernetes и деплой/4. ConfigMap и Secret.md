...
flowchart LR
    ...
    subgraph Build["CI/CD Pipeline"]
        Source["Исходный код Go"]:::process --> Compile["go build -tags netgo"]
...
flowchart TD
    ...
    subgraph HostNode["Файловая система узла (управляется kubelet)"]
        Kubelet["kubelet (Node Worker):::accent"] -->|"1. Создает каталог с новыми файлами"| DirNew["..2026_09_17_12_00_01"]
        DirOld["..2026_09_17_11_45_00"]:::process
