...
flowchart LR
    ...
    A["Metrics Server\n(Сбор метрик с kubelet cAdvisor):::network"] -->|"CPU/RAM использование"| B["K8s API Server"]
...
flowchart TD
    ...
    classDef network  fill:#881337,stroke:#fb7185,stroke-width:1px,color:#f8fafc
    classDef accent   fill:#1e1b4b,stroke:#818cf8,stroke-width:1px,color:#f8fafc
    Alloc["Выделение памяти (куча растет до 75%):::process"] -->|"HPA видит порог > 70%"| ScaleUp["HPA добавляет поды (Scale Up)"]
...
flowchart LR
    ...
    classDef network  fill:#881337,stroke:#fb7185,stroke-width:1px,color:#f8fafc
    classDef accent   fill:#1e1b4b,stroke:#818cf8,stroke-width:1px,color:#f8fafc
    GoApp["Go Application\n(/metrics endpoint):::process"] -->|"Scrape metrics"| Prom["Prometheus TSDB"]
