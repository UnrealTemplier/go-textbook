...
flowchart TD
    ...
    style C fill:#131d33,stroke:#10b981,stroke-width:2px,color:#f8fafc
    style D fill:#131d33,stroke:#10b981,stroke-width:2px,color:#f8fafc
    style E fill:#1e1b4b,stroke:#f59e0b,stroke-width:2px,color:#f8fafc
```
...
flowchart TD
    ...
    style BatchSpan fill:#1e293b,stroke:#f59e0b,stroke-width:2px,color:#f8fafc
    style S1 fill:#131d33,stroke:#38bdf8,stroke-width:2px,color:#f8fafc
    style S2 fill:#131d33,stroke:#38bdf8,stroke-width:2px,color:#f8fafc
    style S3 fill:#131d33,stroke:#38bdf8,stroke-width:2px,color:#f8fafc
```
