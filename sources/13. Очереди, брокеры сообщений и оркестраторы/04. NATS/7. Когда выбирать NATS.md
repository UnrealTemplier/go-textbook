...
> *«Простота — непременное условие надежности. Прежде чем браться за инструмент, требующий целой команды для обслуживания, спросите себя: не принесет ли больше пользы более простое решение с четкими границами?».*    
> — Брайан Керниган
...
graph LR
    ...
    style NS fill:#1e293b,stroke:#6366f1,stroke-width:2px,color:#f8fafc
    style OS fill:#131d33,stroke:#38bdf8,stroke-width:2px,color:#f8fafc
    style IS fill:#131d33,stroke:#38bdf8,stroke-width:2px,color:#f8fafc
    style ES fill:#131d33,stroke:#10b981,stroke-width:2px,color:#f8fafc
    style AS fill:#131d33,stroke:#10b981,stroke-width:2px,color:#f8fafc
```
...
flowchart TD
    ...
    style Start fill:#1e293b,stroke:#6366f1,stroke-width:2px,color:#f8fafc
    style NATS_Core fill:#064e3b,stroke:#10b981,stroke-width:2px,color:#f8fafc
    style NATS_JS fill:#064e3b,stroke:#10b981,stroke-width:2px,color:#f8fafc
    style RabbitMQ fill:#7c2d12,stroke:#f97316,stroke-width:2px,color:#f8fafc
    style Kafka fill:#1e1b4b,stroke:#818cf8,stroke-width:2px,color:#f8fafc
```
