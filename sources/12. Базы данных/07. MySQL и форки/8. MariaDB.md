...
flowchart TD
    ...
    style SQL fill:#0f172a,stroke:#38bdf8,stroke-width:2px,color:#f8fafc
    style Engines fill:#0f172a,stroke:#818cf8,stroke-width:1px,color:#f8fafc
    style InnoDB fill:#1e293b,stroke:#38bdf8,stroke-width:1px,color:#f8fafc
    style Aria fill:#1e293b,stroke:#34d399,stroke-width:1px,color:#f8fafc
    style ColumnStore fill:#1e293b,stroke:#fbbf24,stroke-width:1px,color:#f8fafc
    style MyRocks fill:#1e293b,stroke:#f87171,stroke-width:1px,color:#f8fafc
```
...
flowchart TD
    ...
    style AppLayer fill:#0f172a,stroke:#38bdf8,stroke-width:2px,color:#f8fafc
    style GaleraCluster fill:#0f172a,stroke:#818cf8,stroke-width:2px,color:#f8fafc
    style Node1 fill:#1e293b,stroke:#34d399,stroke-width:2px,color:#f8fafc
    style Node2 fill:#1e293b,stroke:#34d399,stroke-width:2px,color:#f8fafc
    style Node3 fill:#1e293b,stroke:#34d399,stroke-width:2px,color:#f8fafc
```
