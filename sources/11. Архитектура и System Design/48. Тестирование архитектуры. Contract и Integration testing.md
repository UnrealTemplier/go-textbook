...
flowchart TD
    ...
    subgraph BrokerSide["2. Публикация и хранение (Pact Broker)"]
        ...
        Matrix["Matrix: can-i-deploy?<br>Проверка совместимости версий"]:::warning
        PactBroker --- Matrix
    end
...
flowchart LR
    ...
    Stage4["4. Pre-Merge Verification<br>• E2E smoke tests<br>• Нагрузочный бенчмаркинг"]:::process
