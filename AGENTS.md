...
- [ ] **Шаг 5: Итеративная глубокая авторская редактура (Кернигановский стандарт)**
  ...
  - [ ] Модуль 10 («10. Проектирование API и Сетевые протоколы», 40 лекций):
    - [x] Блок 1: Основы REST, Resource-Oriented Design и семантика HTTP (лекции 1–10) — 10/10 (100% верифицировано).
    - [ ] Блок 2: Продвинутый REST, кэширование, OpenAPI и основы gRPC (лекции 11–18) — 0/8.
    - [ ] Блок 3: Сравнение протоколов, GraphQL, Real-time (WebSockets, SSE) и API Gateways (лекции 19–26) — 0/8.
    - [ ] Блок 4: Совместимость, безопасность, квоты, наблюдаемость и тестирование (лекции 27–33) — 0/7.
    - [ ] Блок 5: Продвинутое тестирование, эволюция контрактов, надежность и итоги (лекции 34–40) — 0/7.
  - [ ] Последующие модули 11–22.
...
- **Статус:** 🔄 В процессе глубокой авторской редактуры (10/40 лекций вычитано и верифицировано в Кернигановском стандарте)
- **Статей:** `40` | **Диаграмм Mermaid:** `43` | **Объем:** `~580 КБ` | **Подразделов:** `1`
...
| **Блок 2: Продвинутый REST, кэширование, OpenAPI и основы gRPC** | 11–18 | ⏳ В очереди (0/8) | Rate limiting (Token Bucket/Leaky Bucket), HTTP-кэширование (ETag, Cache-Control), ключи идемпотентности, OpenAPI 3.0/Swagger, кодогенерация, основы gRPC, Protobuf, Streaming RPC |
| **Блок 3: Сравнение протоколов, GraphQL, Real-time и API Gateways** | 19–26 | ⏳ В очереди (0/8) | gRPC vs REST, GraphQL (схема, резолверы, N+1), WebSocket, Server-Sent Events, Long Polling, паттерны API Gateway и BFF |
| **Блок 4: Совместимость, безопасность, квоты, наблюдаемость и тестирование** | 27–33 | ⏳ В очереди (0/7) | Обратная совместимость (Hyrum's Law), Auth/OAuth2/JWT, mTLS, распределенный Rate Limiting, OpenTelemetry трейсинг, метрики и тестирование API |
| **Блок 5: Продвинутое тестирование, эволюция контрактов, надежность и итоги** | 34–40 | ⏳ В очереди (0/7) | Contract testing (Pact), Chaos engineering, документация и DX, Deprecation-стратегии, граничные случаи, производительность и итоги раздела |
