...
- [ ] **Шаг 5: Итеративная глубокая авторская редактура (Кернигановский стандарт)**
  ...
  - [ ] Модуль 11 («11. Архитектура и System Design», 54 лекции):
    - [ ] Блок 1: Архитектурные основы, требования, масштабирование и монолиты (лекции 1–10) — 0/10.
    - [ ] Блок 2: Архитектурные паттерны кода, DDD, Clean Architecture и паттерны Go (лекции 11–18) — 0/8.
    - [ ] Блок 3: Распределенные системы, коммуникация, события и транзакции (лекции 19–27) — 0/9.
    - [ ] Блок 4: Надежность данных, CAP, шардирование, репликация и устойчивость (лекции 28–38) — 0/11.
    - [ ] Блок 5: Observability, потоки данных, безопасность, эволюция и System Design интервью (лекции 39–54) — 0/16.
  - [ ] Последующие модули 12–22.
...
- **Статус:** 🔄 В процессе глубокой авторской редактуры (0/54 лекций вычитано и верифицировано в Кернигановском стандарте)
- **Статей:** `54` | **Диаграмм Mermaid:** `62` | **Объем:** `916.7 КБ` | **Подразделов:** `1`

| Тематический блок | Лекции | Статус редактуры | Ключевые концепции |
|---|:---:|:---:|---|
| **Блок 1: Архитектурные основы, требования, масштабирование и монолиты** | 1–10 | ⏳ В очереди (0/10) | Уровни абстракции, функциональные/нефункциональные требования, SLA/SLO/SLI, Latency/Throughput/Availability, масштабирование, Stateless vs Stateful, Монолит, Микросервисы, Модульный монолит |
| **Блок 2: Архитектурные паттерны кода, DDD, Clean Architecture и паттерны Go** | 11–18 | ⏳ В очереди (0/8) | SOA, Domain-Driven Design (Bounded Context, Aggregate), Hexagonal Architecture (Ports and Adapters), Clean Architecture, Layered 3-tier, Standard Go Layout, Dependency Injection, 12 Factor App |
| **Блок 3: Распределенные системы, коммуникация, события и транзакции** | 19–27 | ⏳ В очереди (0/9) | Синхронное vs асинхронное взаимодействие, RPC vs REST vs Messaging, Event-Driven Architecture, Pub/Sub, Очереди и Стримы, CQRS, Event Sourcing, 2PC транзакции, Saga Pattern, Idempotency |
| **Блок 4: Надежность данных, CAP, шардирование, репликация и устойчивость** | 28–38 | ⏳ В очереди (0/11) | Паттерны кэширования, модели согласованности, CAP-теорема, Partitioning и Sharding, Репликация, Балансировка нагрузки, Service Discovery, API Gateway/BFF, Circuit Breaker, Bulkhead, Rate Limiting |
| **Блок 5: Observability, потоки данных, безопасность, эволюция и System Design интервью** | 39–54 | ⏳ В очереди (0/16) | Observability, Distributed Tracing, Data Pipelines, Batch vs Stream, Backpressure, Threat Modeling, Zero Trust, версионирование, Zero-downtime миграции, Chaos Engineering, Cost Optimization, System Design интервью и антипаттерны |
