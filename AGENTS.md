...
- [ ] **Шаг 5: Итеративная глубокая авторская редактура (Кернигановский стандарт)**
  ...
  - [ ] Модуль 3 («Компьютерные сети и сетевой стек», 44 лекции):
    ...
    - [ ] Блок 2: Транспортный уровень, сокеты и DNS (лекции 10–19) — 0/10.
...
- **Статус:** 🔄 В процессе редактуры (9/44 лекций вычитано и верифицировано в Кернигановском стандарте)
- **Статей:** `44` | **Диаграмм Mermaid:** `73` | **Объем:** `815 КБ` | **Подразделов:** `1`
...
| **Блок 2: Транспортный уровень, сокеты и DNS** | 10–19 | 🔄 В очереди (0/10) | TCP handshake, flow control, congestion control, TCP flags, UDP, Socket API, DNS, DNSSEC, DoH |
