...
- [ ] **Шаг 5: Итеративная глубокая авторская редактура (Кернигановский стандарт)**
  ...
  - [ ] Модуль 17 («17. Безопасность (AppSec в Go)», 42 лекции) — в процессе глубокой авторской редактуры:
    - [ ] Подраздел 1: Фундамент (лекции 1–5).
    - [ ] Подраздел 2: Аутентификация и авторизация (лекции 1–7).
    - [ ] Подраздел 3: Криптография (лекции 1–6).
    - [ ] Подраздел 4: Уязвимости (лекции 1–7).
    - [ ] Подраздел 5: Безопасность API (лекции 1–6).
    - [ ] Подраздел 6: Инфраструктура и секреты (лекции 1–6).
    - [ ] Подраздел 7: Практика (лекции 1–5).
  - [ ] Последующие модули 18–22.
