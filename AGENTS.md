...
- **Статус:** 🔄 В процессе редактуры (10/48 лекций вычитано и верифицировано в Кернигановском стандарте)
- **Статей:** `48` | **Диаграмм Mermaid:** `55` | **Объем:** `750 КБ` | **Подразделов:** `1`
...
| **Блок 2: Файловая система, ОС, конфигурация и логирование** | 11–18 | ⏳ В процессе (0/8) | os (файлы, окружение, сигналы, Exit), path/filepath (кроссплатформенность), io/fs (абстрактная FS, ReadDirFS), embed (embed.FS), flag (парсинг флагов), log и slog (структурированное логирование, Level, Handler, JSONHandler), context (отмена, таймауты, metadata), time (Time, Duration, Timer, Ticker, монотонные часы) |
